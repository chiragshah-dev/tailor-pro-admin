...
# Admin role sanity (optional if already present)
# if defined?(AdminUser) && AdminUser.table_exists?
#   admin = AdminUser.first || AdminUser.create!(email: "admin@example.com", password: "password", password_confirmation: "password")
#   admin.add_role(:super_admin) if admin.respond_to?(:add_role) && !admin.has_role?(:super_admin)
# end

# App user (owner of dresses, etc.)
app_user = User.first
